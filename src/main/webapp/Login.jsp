<%@ page language="java" import="java.util.*,com.greathiit.evaluating.function.*,java.sql.*" pageEncoding="UTF-8"%>
<%
...
<html>
  ...
  <%
	...
	<div id="login-bottom">
		<p align="center" style="font-size: 13px;">哈尔滨信息工程学院-综合素质测评系统 BATE 1.0.0</p>
	</div>
</div>
<script type="text/javascript">
