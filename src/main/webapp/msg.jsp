...
<%@ page import="java.sql.*,java.text.*,java.util.Date,com.greathiit.evaluating.function.*"%>
<%
...
if(act!=null&&act.equals("del")&&request.getParameterValues("ids[]")!=null&&request.getParameter("mod")!=null){

	Sql_op op = new Sql_op();
	for(String id:request.getParameterValues("ids[]")){
		op.delete("exam_msg", "id='"+id+"'");
	}
	op.close();
%>
